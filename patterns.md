...
>
> <span>[</span>**Objectives**: *Explain the purpose(s) of the proposed
> solution’s functioning, if they aren’t fully specified by the
> description of the solution itself.*<span>]</span>
>
...
![image](../pictures/pattern-language.jpg)
...
[*Assess*](http://peeragogy.org/assessment/) – represent big clusters of
patterns that are likely to come up time and again in various projects. 
We can think of these as East, South, West, and North in the diagram
above. You are of course encouraged to invent your own patterns and to
connect them in new ways. Each project has a unique design, and it’s own
unique way in which things play out in practice.  What we’ve put
together here is a starter kit.
...
> this deeper level of structure, that the origin of life occurs.”
> <span>[</span>2<span>]</span>

The peeragogy patterns suggest a *social* way to implement useful
problem-solving heuristics [3]:

-   We simplify things for **Newcomers**. We don’t expect a newcomer to
    enter at full speed.

-   We use a **Roadmap** to guide us from one phase to another, while
    the project’s central **Heartbeat** helps us attend to the central
    focus.

-   We announce significant changes through a **Wrapper** who describes
    any new directions taken by the project.

-   We divide work up not only horizontally among different **Roles**,
    but also temporally by using the **Roadmap**.

-   Whenever we’re **Creating a Guide** we’re really thinking in terms
    of analogies.

-   When we ask for help, we often avail ourselves of some sort of
    **Moderation**.

-   One simple way to ask for help is **Polling for Ideas**.

-   If you know the answer (or if you know someone who knows), then you
    may be able to reuse it. We often reuse instead of making-anew: ask
    “**Use or Make**?”

-   It is important to give it a rest so as not to exhaust one’s own
    **Carrying Capacity** – or get too far out of sync with the group.

-   One of the things that experts are good at is **Discerning a
    Pattern**. This allows them to simplify their processing. We like to
    describe and share the patterns we find.

-   If we know why something is hard, then we may be able to use that
    information to **Create a Guide** that will help get around, or at
    least better cope with, the difficulty.
