...
#+BEGIN_QUOTE
  [[file:static/images/attention.png]] *Attention*: due to limited energy, we
  need to ask: where should we set the focus?

  [[file:static/images/interest.png]] *Interest*: new experiences catch our
  attention.

  [[file:static/images/meaning.png]] *Meaning*: shared history makes things meaningful.
#+END_QUOTE
...
[[file:static/images/ChristsPieces.jpg]]\\
...
** BACK Revisit outtakes and use them as compost pile            :scrapbook:
- We have hung on to a bunch of outtakes.  Maybe these should be restored in the form of mini-Handbooks?
- Some [[file:outtakes.org][Outtakes]] are here
** BACK Connect Patterns, Next Steps PARs, and CLA
...
** BACK Process ‘orphan’ chapters
- [[file:peeragogy_handbook_v4_editorial_remarks.org][Peeragogy Handbook v4 — Editorial Remarks]]
** BACK Software Tools
- Do some workshops to help everyone get up to speed with Emacs software
** BACK Emacs Research Group, meetings, report back with PARs, maybe a chapter + tools Peeragogy bolt-on for Emacs JOE + RAY 1/1/21 100%
** BACK Workshop w/ Emacs groups to share Org Mode skills
** BACK Submit other papers
- PLoP
- European Journal of Future Studies
- ...?
** BACK Mailing list
** BACK Events
** BACK What to do with the PARs
