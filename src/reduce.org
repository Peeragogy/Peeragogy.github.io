...
** BACK Any miscellaneous follow up from paper for Special Issue of Futures Journal for Anticipation :paper:
** BACK Do a CLA using collected peeragogy PARs as data :paper:
