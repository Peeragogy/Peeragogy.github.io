...
*** DONE [#A] Prepare next event for the ‘course’ and invite people
*** TODO [#A] Review the peeragogy backlog to decide which things are wontfix, what other categories need to be created, etc.
